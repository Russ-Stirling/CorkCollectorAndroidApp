...
public class WineCellarPop extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String url = "http://35.183.3.83/api/User/Tastings?userId="+ userId + "&type=wine"; //TODO: modify once complete
                ...
                new Response.Listener<JSONArray>()
                {
                    ...
                    public void onResponse(JSONArray cellarList) {
                        ...
                        try {
                            ...
                            for(int tastingListIndex = 0; tastingListIndex < cellarList.length(); tastingListIndex++)
                            {
                                String wineName = cellarList.getJSONObject(tastingListIndex).getString("wineName");
                                String wineryName = cellarList.getJSONObject(tastingListIndex).getString("wineryName");

                                //TODO: create buttons with onclick functionality
