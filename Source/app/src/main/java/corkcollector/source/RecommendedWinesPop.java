...
/**
 * Created by Bailey on 3/29/2018.
 */

public class RecommendedWinesPop extends Activity{
    Bundle extras;
    String authToken;
    String userName;
    String userId;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recommended_wines_popup_window);
        ...
        String url = "http://35.183.3.83/api/Recommendation/List?userId="+ userId;
            ...
            try {
                ...
                wineGrid.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent myIntent = new Intent(RecommendedWinesPop.this,
                                WineScreen.class);
